...
class HandleGenerator:
    ...
    def generate(file: IOBase, data: dict[str, Any]) -> None:
        ...
        file.write("\n")
        file.write(f"    public {data_name}(nint value)\n")
        file.write("    {\n")
        file.write("        _handle = value;\n")
        file.write("    }\n")
        file.write("\n")
        file.write(f"    public unsafe {data_name}(void* value)\n")
        file.write("    {\n")
        file.write("        _handle = (nint)value;\n")
        file.write("    }\n")
        file.write("\n")
        file.write("    public bool IsAllocated\n")
        file.write("    {\n")
        file.write("        get => _handle != 0;\n")
        file.write("    }\n")
        file.write("\n")
        file.write("    public nint ToIntPtr()\n")
        file.write("    {\n")
        file.write("        return _handle;\n")
        file.write("    }\n")
        file.write("\n")
        file.write("    public unsafe void* ToPointer()\n")
        file.write("    {\n")
        file.write("        return (void*)_handle;\n")
        file.write("    }\n")
        file.write("\n")
        file.write(f"    public bool Equals({data_name} other)\n")
        file.write("    {\n")
        file.write("        return _handle == other._handle;\n")
        file.write("    }\n")
        file.write("\n")
        file.write("    public override bool Equals(object? obj)\n")
        file.write("    {\n")
        file.write(f"        return obj is {data_name} other && _handle == other._handle;\n")
        file.write("    }\n")
        file.write("\n")
        file.write("    public override int GetHashCode()\n")
        file.write("    {\n")
        file.write("        return _handle.GetHashCode();\n")
        file.write("    }\n")
        file.write("\n")
        file.write(f"    public static explicit operator {data_name}(nint value)\n")
        file.write("    {\n")
        file.write(f"        return new {data_name}(value);\n")
        file.write("    }\n")
        file.write("\n")
        file.write(f"    public static unsafe explicit operator {data_name}(void* value)\n")
        file.write("    {\n")
        file.write(f"        return new {data_name}(value);\n")
        file.write("    }\n")
        file.write("\n")
        file.write(f"    public static explicit operator nint({data_name} value)\n")
        file.write("    {\n")
        file.write("        return value._handle;\n")
        file.write("    }\n")
        file.write("\n")
        file.write(f"    public static unsafe explicit operator void*({data_name} value)\n")
        file.write("    {\n")
        file.write("        return (void*)value._handle;\n")
        file.write("    }\n")
        if data_parent:
            file.write("\n")
            file.write(f"    public static implicit operator {data_name}({data_parent} value)\n")
            file.write("    {\n")
            file.write(f"        return new {data_name}((nint)value);\n")
            file.write("    }\n")
        file.write("\n")
        file.write(f"    public static bool operator ==({data_name} left, {data_name} right)\n")
        file.write("    {\n")
        file.write("        return left._handle == right._handle;\n")
        file.write("    }\n")
        file.write("\n")
        file.write(f"    public static bool operator !=({data_name} left, {data_name} right)\n")
        file.write("    {\n")
