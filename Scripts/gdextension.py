    ...
    def to_csharp(self, stylizer: GDExtensionStylizer) -> CSharpStructure:
        def initialize() -> CSharpMethod:
            def body() -> Iterable[str]:
                ...
                for interface, field in zip(self.interface, csharp_class.fields):
        ...
        def load() -> CSharpMethod:
            ...
            parameter1.type = stylizer.get_expansion("GDExtensionInterfaceGetProcAddress")
        ...
        def throw_if_invalid() -> CSharpMethod:
            def body() -> Iterable[str]:
        ...
        def throw_for_invalid_function() -> CSharpMethod:
            def body() -> Iterable[str]:
        ...
        csharp_class.methods.append(initialize())
        for interface in self.interface:
            field, method = interface.to_csharp(stylizer)
            csharp_class.fields.append(field)
            csharp_class.methods.append(method)
        csharp_class.methods.append(load())
        csharp_class.methods.append(throw_if_invalid())
...
class GDExtensionEnumeration(GDExtensionType):
    ...
    def to_csharp(self, stylizer: GDExtensionStylizer) -> CSharpEnumeration:
        ...
        if description := self.description:
            enumeration.documentation.description = stylizer.documentation(description)
        if self.deprecated:
...
class GDExtensionConstant:
    ...
    def to_csharp(self, stylizer: GDExtensionStylizer) -> CSharpConstant:
        ...
        if description := self.description:
            constant.documentation = XMLDocumentation.summary(stylizer.documentation(description))
        return constant
...
class GDExtensionStructure(GDExtensionType):
    ...
    def to_csharp(self, stylizer: GDExtensionStylizer) -> CSharpStructure:
        ...
        if description := self.description:
            structure.documentation = XMLDocumentation.summary(stylizer.documentation(description))
        if self.deprecated:
...
class GDExtensionField:
    ...
    def to_csharp(self, stylizer: GDExtensionStylizer) -> CSharpField:
        ...
        if description := self.description:
            field.documentation = XMLDocumentation.summary(stylizer.documentation(description))
        return field
...
class GDExtensionParameter:
    ...
    def to_csharp(self, stylizer: GDExtensionStylizer) -> CSharpParameter:
        ...
        if description := self.description:
            parameter.documentation = XMLDocumentation.param(parameter.name, stylizer.documentation(description))
        return parameter
...
class GDExtensionInterfaceFunction(GDExtensionFunction):
    ...
    def to_csharp(self, stylizer: GDExtensionStylizer) -> tuple[CSharpField, CSharpMethod]:
        ...
        method.is_static = True
        if description := self.description:
            method.documentation = XMLDocumentation.summary(stylizer.documentation(description))
