...
class HandleGenerator:
    ...
    def generate(file: IOBase, data: dict[str, Any]) -> None:
        ...
        file.write("    }\n")
        file.write("\n")
        file.write(f"    public static explicit operator {data_name}(void* pointer)\n")
        file.write("    {\n")
        file.write(f"        return new {data_name}(pointer);\n")
        file.write("    }\n")
        file.write("\n")
        file.write(f"    public static explicit operator void*({data_name} handle)\n")
        file.write("    {\n")
        file.write("        return handle._pointer;\n")
        file.write("    }\n")
        if data_parent:
            file.write("\n")
...
class AliasGenerator:
    ...
    def generate(file: IOBase, data: dict[str, Any]) -> None:
        ...
        if data_is_bool:
            ...
            file.write("    {\n")
            file.write(f"        _value = (byte)(value ? 1 : 0);\n")
            file.write("    }\n")
            file.write("\n")
        ...
        if data_type.is_builtin:
            ...
            file.write("    }\n")
        file.write("\n")
        file.write(f"    public static explicit operator {data_name}({data_type.name} value)\n")
        file.write("    {\n")
        file.write(f"        return new {data_name}(value);\n")
        file.write("    }\n")
        file.write("\n")
        file.write(f"    public static explicit operator {data_type.name}({data_name} alias)\n")
        file.write("    {\n")
        if data_type.is_builtin:
            file.write("        return alias._value;\n")
        else:
            file.write("        return alias.Value;\n")
        file.write("    }\n")
        if data_is_bool:
            file.write("\n")
